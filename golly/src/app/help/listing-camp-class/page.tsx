...
export default function ListingCampClassPage() {
  return (
    <HelpArticleLayout
    ...
    >
      <p>
        Hosting on Golly is an easy way to share what you love and connect with
      ...
      <p>
        ...
        <strong>Publish</strong> to make it live on Golly. Parents can then

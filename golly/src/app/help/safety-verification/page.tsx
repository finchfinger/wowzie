...
export default function SafetyVerificationPage() {
  return (
    <HelpArticleLayout
      title="Safety and verification"
      description="How Golly screens listings, verifies hosts, and supports safe experiences for kids and families."
    >
      <p>
        The safety and wellbeing of kids and families is at the heart of Golly.
      ...
      <p>
        Each new listing is reviewed by Golly&apos;s team to ensure accuracy, age
      ...
      <p>
        All transactions take place directly through Golly&apos;s payment system and

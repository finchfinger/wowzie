...
export default function ManagingKidProfilesPage() {
  return (
    <HelpArticleLayout
    ...
    >
      <p>
        Golly lets you create and manage profiles for each of your children so
      ...
      <p>
        When you book, Golly will ask which child or children the booking is for.
      ...
      <p>
        ...
        class. Golly never shares personal information publicly.
      </p>

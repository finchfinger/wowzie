...
export default function MessagingHostsPage() {
  return (
    <HelpArticleLayout
    ...
    >
      <p>
        Communication is key to great experiences. Golly&apos;s built-in messaging
      ...
      <p>
        Use Golly messaging only for questions related to listings or bookings.
        Sharing personal contact details or arranging payments outside Golly
      ...
      <p>
        ...
        unanswered for more than two days, you can contact Golly Support for
        help.
      </p>

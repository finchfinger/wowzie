...
export default function ReviewsFeedbackPage() {
  return (
    ...
    >
      <p>
        Reviews help build trust across the Golly community for both parents and
      ...
      <p>
        To keep reviews trustworthy, edits and removals are limited. Golly only
      ...
      <h2>Helpful tip</h2>
      <p>
        Positive reviews make your listings stand out. If you&apos;re a host,
        encourage happy parents to share their experience right after the camp
        ends.
      </p>
    </HelpArticleLayout>
  );

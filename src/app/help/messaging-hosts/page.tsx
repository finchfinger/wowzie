...
export default function MessagingHostsPage() {
  return (
    ...
    >
      <p>
        Communication is key to great experiences. Wowzi&apos;s built-in messaging
      ...
      <p>
        Use Wowzi messaging only for questions related to listings or bookings.
        Sharing personal contact details or arranging payments outside Wowzi
      ...
      <p>
        ...
        unanswered for more than two days, you can contact Wowzi Support for
        help.
      </p>

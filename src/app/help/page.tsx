...
const CAMP_ARTICLES = [
  ...
  },
  {
    ...
    desc: "How Wowzi screens listings, verifies hosts, and supports safe experiences for kids and families.",
      ...
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Find quick answers and tips to make your Wowzi experience easy, fun, and stress-free.
          </p>
        </div>
        <Link href="/contact">

...
export default function PaymentsPayoutsPage() {
  return (
    ...
    >
      <p>
        Wowzi handles all payments securely so both parents and hosts can focus
        on the experience, not the paperwork.
      </p>

      <h2>How payments work</h2>
      <p>
        Parents pay through Wowzi at the time of booking. Once confirmed, the
      ...
      <h2>Fees</h2>
      <p>
        Wowzi takes a small service fee from each booking to cover platform

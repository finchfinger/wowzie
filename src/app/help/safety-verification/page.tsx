...
export default function SafetyVerificationPage() {
  return (
    <HelpArticleLayout
      ...
      description="How Wowzi screens listings, verifies hosts, and supports safe experiences for kids and families."
    >
      <p>
        The safety and wellbeing of kids and families is at the heart of Wowzi.
      ...
      <p>
        Each new listing is reviewed by Wowzi&apos;s team to ensure accuracy, age
      ...
      <p>
        All transactions take place directly through Wowzi&apos;s payment system and

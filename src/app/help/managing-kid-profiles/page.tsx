...
export default function ManagingKidProfilesPage() {
  return (
    ...
    >
      <p>
        Wowzi lets you create and manage profiles for each of your children so
      ...
      <p>
        When you book, Wowzi will ask which child or children the booking is for.
      ...
      <p>
        ...
        class. Wowzi never shares personal information publicly.
      </p>

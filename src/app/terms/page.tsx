    ...
    <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="rounded-2xl bg-card p-5 sm:p-6 prose prose-sm max-w-none text-foreground">
        ...
        <p className="text-sm text-muted-foreground">
          By accessing or using Wowzi, you agree to be bound by these Terms of Service and all
        ...
        <p className="text-sm text-muted-foreground">
          When you book an activity through Wowzi, you agree to pay the listed price plus any
        ...
        <p className="text-sm text-muted-foreground">
          Wowzi serves as a platform connecting families with activity providers. We are not

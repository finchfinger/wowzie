  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative has-focus:border-foreground/30 border border-input has-focus:ring-1 has-focus:ring-foreground/10 rounded-md",

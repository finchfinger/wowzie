        ...
        <div className="mt-1.5 space-y-0.5">
          {priceLabel && (
            <div className="flex items-center gap-1.5">
              <span className="material-symbols-outlined select-none shrink-0 text-muted-foreground/70" style={{ fontSize: 14 }} aria-hidden>payments</span>
              <p className="text-xs text-muted-foreground">{priceLabel}</p>
            </div>
          )}
          {scheduleLabel && (
            <div className="flex items-center gap-1.5">
              <span className="material-symbols-outlined select-none shrink-0 text-muted-foreground/70" style={{ fontSize: 14 }} aria-hidden>timer</span>
              <p className="text-xs text-muted-foreground">{scheduleLabel}</p>
            </div>
          )}
          {totalCapacity != null && (
            <div className="flex items-center gap-1.5">
              <span className="material-symbols-outlined select-none shrink-0 text-muted-foreground/70" style={{ fontSize: 14 }} aria-hidden>group</span>
              <p

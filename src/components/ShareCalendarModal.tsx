    ...
    >
      <div className="relative w-full max-w-md rounded-3xl bg-card shadow-xl">
        ...
        <div className="px-6 pt-8 pb-6 space-y-5">
          ...
          >
            {copied
              ? <span className="material-symbols-outlined select-none text-emerald-600" style={{ fontSize: 16 }} aria-hidden>check</span>
              : <span className="material-symbols-outlined select-none" style={{ fontSize: 16 }} aria-hidden>content_copy</span>}

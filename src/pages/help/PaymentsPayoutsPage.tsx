...
export const PaymentsPayoutsPage: React.FC = () => (
  <HelpArticleLayout
    title="Payments and payouts"
    description="How you’ll receive payments, payout timing, and what fees apply."
  >
    <p>
      Wowzie handles all payments securely so both parents and hosts can focus
      on the experience, not the paperwork.
    </p>

    <h2>How payments work</h2>
    <p>
      Parents pay through Wowzie at the time of booking. Once confirmed, the
    ...
    <h2>Fees</h2>
    <p>
      Wowzie takes a small service fee from each booking to cover platform
